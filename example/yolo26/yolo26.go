/*
Example code showing how to perform object detection using a YOLO26 model.
*/
package main
...
func main() {
	...
	// read in cli flags
	modelFile := flag.String("m", "../data/models/rk3588/yolo26s-rk3588.rknn", "RKNN compiled YOLO model file")
	...
	saveFile := flag.String("o", "../data/bus-yolo26-out.jpg", "The output JPG file with object detection markers")
	...
	// create YOLO26 post processor
	yoloProcesser := postprocess.NewYOLO26(postprocess.YOLO26COCOParams())
